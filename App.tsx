...
import { Upload, Wand2, AlertCircle, Image as ImageIcon, PaintBucket } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 h-full">
          ...
          <div className="lg:col-span-8 h-full min-h-[500px]">
            {genState.resultImage ? (
              <SpritePreview originalImageUrl={genState.resultImage} />
            ) : (
              <div className="h-full bg-slate-800/50 border-2 border-dashed border-slate-700 rounded-xl flex flex-col items-center justify-center text-slate-500 p-8">
                 ...
                 <p className="text-center max-w-md">
                   Upload a character reference on the left and describe the action you want. 
                   Gemini will generate a sprite sheet that you can preview and slice here.
                 </p>
